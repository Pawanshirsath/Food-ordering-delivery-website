...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="about.html">about us <span class="sr-only"></span></a> </li>
				    <li class="nav-item"> <a class="nav-link active" href="contactus.html">contact us <span class="sr-only"></span></a> </li>
						...
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
									...
									echo  '<li class="nav-item"><a href="logout.php" class="nav-link active">logout</a> </li>';
									 echo  '<li class="nav-item"><a href="admin/update_users1.php" class="nav-link active">user info</a> </li>';
							}
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/img.jpg">
            <div class="hero-inner">	
                <div class="container text-center hero-text font-white">
			      <h1>VEGGIES  GRILLS</h1>
                    <h2 class="font-white space-xs">BEAT HUNGER</h2>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>order from our Restaurant</h4> </div>
                        <!-- end:Step -->
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min ₹ 1000</div>
